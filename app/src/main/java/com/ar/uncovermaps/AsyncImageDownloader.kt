...
class AsyncImageDownloader(private val context: Context, private val fileName: String, private val imageUrl: String?, private val listener: ResultListener) : AsyncTask<Void?, Void?, Void?>() {
